...
class SpeedoMeterView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        //********** FOR CIRCLE OF NEEDLE *********//
        // Add the gray-filled circle at the base of the needle
        circlePaint = Paint().apply {
            color = Color.WHITE
            style = Paint.Style.FILL
        }
        // The size of the circle (adjust as needed)
        val circleRadius = 15f
        // Draw the circle at the base of the needle (center of the gauge)
